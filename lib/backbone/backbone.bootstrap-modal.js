  ...
  ');
    ...
    var Modal = Backbone.View.extend({
        ...
        open: function(cb) {
            ...
            console.log('numModals backdropIndex elIndex', numModals, backdropIndex, elIndex);
            ...
            Modal.count++;
            console.log('Modal.count++', Modal.count, numModals, backdropIndex, elIndex);
        ...
        close: function() {
            ...
            Modal.count--;
            console.log('Modal.count--', Modal.count);
        },
