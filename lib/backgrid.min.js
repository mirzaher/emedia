...
// http://es5.github.com/#x15.5.4.20
    ...
    _.extend(NumberFormatter.prototype, {
        ...
        fromRaw: function (number, model) {
            //console.log('backgrid fromRaw number', number, model);
            ...
            //console.log('backgrid fromRaw integerPart decimalPart',integerPart, decimalPart);
        ...
        toRaw: function (formattedData, model) {
           ...
           // console.log('backgrid toRaw formattedData', formattedData, model);
            ...
            //console.log('backgrid toRaw rawData', rawData, model);
        ...
        _convert: function (data, validate) {
            ...
            if (this.includeDate) {
             //   result = lpad(jsDate.getUTCFullYear(), 4, 0) + '-' + lpad(jsDate.getUTCMonth() + 1, 2, 0) + '-' + lpad(jsDate.getUTCDate(), 2, 0);
                result = lpad(jsDate.getUTCDate(), 2, 0) + '-' + lpad(jsDate.getUTCMonth() + 1, 2, 0) + '-' + lpad(jsDate.getUTCFullYear(), 4, 0);
            }
    ...
    var Body = Backgrid.Body = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            //this.listenTo(collection, "change", this.refresh);//HH
